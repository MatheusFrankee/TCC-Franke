...
class VL53L0X():
    def __init__(self, i2c, address):
        ...
        utime.sleep_ms(100) # tempo ao I2C para inicializar
        self.init()
        self._started = False
    ...
    def init(self, power2v8=True):
        ...
        # desabilitar verificações de limite signal_rate_msrc e signal_rate_pre_range
